...
const Sidebar = ({sport,setSport,setIsSelected,isSelected, lines,isSidebarFavoirit,setIsSidebarFavoirit,setDirection,direction}) => {
  ...
  return (
    ...
    isSidebarFavoirit === false?
      <div>
        <MapOutput sport={sport.value} direction={direction} lines={lines} isSidebarFavoirit={isSidebarFavoirit}/>  
