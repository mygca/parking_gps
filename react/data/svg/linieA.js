...
export const liniea = <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="1727" height="1461" viewBox="0 0 3000 2403" className="svgImage">
  ...
  <g className="train--a">
    ...
    <circle data-ligne="a" data-station-id="128" data-station="cergy-le-haut" cx="806.96" cy="352.13" r="7"/>
    <circle data-ligne="a" data-station-id="131" data-station="cergy-saint-christophe" cx="806.96" cy="412.12" r="7"/>
    <circle data-ligne="a" data-station-id="129" data-station="cergy-prefecture" cx="806.96" cy="472.1" r="7"/>
    <circle data-ligne="a" data-station-id="591" data-station="neuville-universite" cx="806.96" cy="530.26" r="7"/>
    <circle data-ligne="a" data-station-id="202" data-station="conflans-fin-dosie" cx="830.09" cy="593.85" r="7"/>
    <circle data-ligne="a" data-station-id="6" data-station="archeres-ville" cx="863.7" cy="626.81" r="7"/>
    ...
    <circle data-ligne="a" data-station-id="582" data-station="nation" cx="1632.57" cy="1063.93" r="7"/>
    <circle data-ligne="a" data-station-id="913" data-station="vincennes" cx="1707.46" cy="1029.66" r="7"/>
    ...
    <circle data-ligne="a" data-station-id="598" data-station="noisy-le-grand-mont-dest" cx="2025.06" cy="1084.82" r="7"/>
    <circle data-ligne="a" data-station-id="597" data-station="noisy-champs" cx="2105.19" cy="1084.73" r="7"/>
    ...
    <circle data-ligne="a" data-station-id="856" data-station="torcy" cx="2298.63" cy="1084.82" r="7"/>
    <circle data-ligne="a" data-station-id="119" data-station="bussy-saint-georges" cx="2347.79" cy="1056.65" r="7"/>
    <circle data-ligne="a" data-station-id="70" data-station="val-deurope" cx="2376.08" cy="1027.6" r="7"/>
    <circle data-ligne="a" data-station-id="182" data-station="parc-disneyland" cx="2405.58" cy="998.32" r="7"/>
    <circle data-ligne="a" data-station-id="577" data-station="nanterre-prefecture" cx="1064.5" cy="830.77" r="7"/>
    <circle data-ligne="a" data-station-id="820" data-station="saint-germain-en-laye" cx="673.05" cy="888.03" r="7"/>
    ...
    <circle data-ligne="a" data-station-id="172" data-station="chatou-croissy" cx="870.34" cy="888.03" r="7"/>
    ...
    <circle data-ligne="a" data-station-id="578" data-station="nanterre-universite" cx="1024.26" cy="790.31" r="7"/>
    ...
    <circle data-ligne="a" data-station-id="87" data-station="boissy-saint-leger" cx="1963.87" cy="1376.5" r="7"/>
    ...
    <circle data-ligne="a" data-station-id="142" data-station="champigny" cx="1863.66" cy="1276.31" r="7"/>
    <circle data-ligne="a" data-station-id="431" data-station="le-parc-de-saint-maur" cx="1829.69" cy="1242.92" r="7"/>
    <circle data-ligne="a" data-station-id="826" data-station="saint-maur-creteil" cx="1797.61" cy="1209.78" r="7"/>
    <circle data-ligne="a" data-station-id="378" data-station="joinville-le-pont" cx="1764.67" cy="1177.27" r="7"/>
    <circle data-ligne="a" data-station-id="594" data-station="nogent-sur-marne" cx="1754.59" cy="1123.75" r="7"/>
