...
EOF;
    ...
    private function addElementToGhost()
    {
        ...
        return '<path d="'.self::GHOST_ADDONS[date('m-d')].'" fill="#fff" fillOpacity="0.6"></path>';
    }
}
